local Config = {
    { -- earth totem
        ...
        {
            type = "macro",
            macrotext = "/cast Tremor Totem"
        },
        {
            type = "macro",
            macrotext = "/cast Stoneclaw Totem"
        },
    },
    { -- fire totem
        {
        ...
        {
            type = "macro",
            macrotext = "/cast Flametongue Totem"
        },
    },
    { -- water totem
        {
        ...
        {
            type = "macro",
            macrotext = "/cast Mana Spring Totem"
        },
        {
            type = "macro",
            macrotext = "/cast Poison Cleansing Totem"
        },
    },
    { -- air totem
        {
            type = "macro",
            macrotext = "/cast Grounding Totem"
        },
    },
}
